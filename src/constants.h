...
const int solver_PcrAdvection  = 0; // Advective term of the CR Pressure (the classical one -> V_A*grad ...)
...
const double log_first_data    = 0.3*kyr;     // 
const int delta_log_output     = 100;       // Number of time-step between two LogOutput
const double Tmax              = 9*kyr; //200.1*kyr;           // Define the limit time of your simulation 
